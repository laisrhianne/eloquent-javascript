...
module.exports.bigOak = network.nodes["Big Oak"]
module.exports.everywhere = network.everywhere.bind(network)
module.exports.defineRequestType = network.defineRequestType.bind(network)
